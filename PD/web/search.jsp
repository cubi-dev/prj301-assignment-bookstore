<%-- 
    Document   : search
    Created on : Oct 20, 2022, 3:24:11 PM
    Author     : ASUS
--%>

<%--<%@page import="java.util.List"%>
<%@page import="java.util.List"%>
<%@page import="pd.registration.RegistrationDTO"%>--%>
...
<html>
    ...
    <body>
        ...
        <form action="searchLastNameController">
            ...
            <input type="submit" value="Search" name="btAction" /><br/><br/><%-- Copy value HERE --%>
        </form><br/>
